...
import { HighlightRenderer, HighlightSegment } from '@/lib/highlights/HighlightRenderer'
...
export function useHighlights({
  ...
  const [activeHighlight, setActiveHighlight] = useState<Id<'highlights'> | null>(null)
    ...
    const manager = new SelectionManager(
      ...
      (textSelection) => {
        ...
        setSelection({
          ...
          startPath: HighlightSerializer.getNodePath(textSelection.startContainer),
  ...
  // Update highlight
  const handleUpdateHighlight = useCallback(async (
  ...
  // Delete highlight
  const handleDeleteHighlight = useCallback(async (highlightId: Id<'highlights'>) => {
    try {
